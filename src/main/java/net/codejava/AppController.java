...
import net.codejava.model.repo.userRepository;
...
public class AppController {
	...
	public String sendPlainTextEmail(Model model) {
		String from = "vanviet2304@gmail.com";
		String to = "levanviet2021@gmail.com";
		
		SimpleMailMessage message = new SimpleMailMessage();
		message.setFrom(from);
		message.setTo(to);
		message.setSubject("Test send email 2");
		message.setText("Hello V.");
		
		mailSender.send(message);
//		User a = userRepository.findByCode("A");
